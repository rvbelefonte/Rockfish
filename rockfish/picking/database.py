...
class PickDatabaseConnection(sqlite3.Connection):
    """
    ...
    def commit(self):
        """
        Updates counts and commits changes to the database.
        """
    ...
    def _update(self, table, **kwargs):
        ...
        """
        pvalues = self._select_field_values(self.PICK_TABLE, **kwargs)
